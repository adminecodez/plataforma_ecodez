    ...
    <body>
      <header class="clearfix">
        <table style="border-collapse;width:760px" border="1">
          <thead>
            <tr>
              <th width="200px" style="border-top:0px;border-left:0px;border-bottom:0px;border-right:0px"><img src="img/logo.png" width="150px"></th>
              ...
              <th width="100px" style="text-align:center">
                <h4 style="color:black">INFORME DE COMPRAS GENERAL PARA PAGO POR INCENTIVO</h4>
              </th>
            </tr>
          </thead>
        </table>
        <div id="project">
          ...
          <div><span style="color:black;font-size:13px"><b>PRECIO POR TONELADA: $</b> '.$row1['precio_tonelada'].'</span></div>
        </div>
      </header>
      <main>';
        $query2="SELECT
    ...
    FROM
        ...
        <table>
          ...
          <tbody>';
           ...
           categoria.categoria_nombre
            ...
            <tr>
            <td colspan="4" class="TOTAL" style="font-size:10px"><b>VALOR INCENTIVO</b></td>
              <td style="text-align:center;font-size:10px">$ '.round($totalcantidad*$row1['precio_tonelada'],2).'</td>
            </tr>'; 
        ...
        <table width="100%" style="text-align:center;">
            <tr>
                ...
                <td>
                        <b>VALOR INCENTIVO TOTAL: $</b>'.$tontotal.'
                </td>
            </tr>
        </table>
      </main>
