...
<div class="row">
    <div class="col-md-12">
        <div class="ibox ibox-default">
            <div class="ibox-head">
                <div class="ibox-title">MODULO VENTA</div>
                <div class="ibox-tools">
                        <button class="btn btn-danger" onclick="cargar_contenido('contenido_principal','venta/vista_venta_registro.php')">Nuevo Registro</button>
                </div>
            </div>
            <div class="ibox-body">
                <div class="row">
