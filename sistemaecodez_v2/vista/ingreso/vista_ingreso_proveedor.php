        ...
        <div class="ibox ibox-default">
            ...
            <div class="ibox-body">
                <div class="row">
                    ...
                    <div class="col-2">
                        <label for="">&nbsp;</label><br>
                        <button class="btn btn-success" style="width:100%" onclick="listar_ingreso_proveedor()"><i class="fa fa-search"></i>&nbsp;Buscar</button>
                    </div>   
                    <div class="col-md-2">
                        <label for="">&nbsp;</label><br>
                        <button class="btn btn-warning" style="width:100%" onclick="Generar_Reporte_Proveedor()"><i class="fa fa-print"></i>&nbsp;Generar Reporte</button>
                    </div>                
                </div><br>
                    <table id="tabla_ingreso_proveedor" class="display" style="width:100%">
                        <thead>
                            <tr>
